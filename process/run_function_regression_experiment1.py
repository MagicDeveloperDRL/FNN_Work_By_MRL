...
import random
import time
from FNN_Work_By_Liu.process.network import Network
...
"""本实验的神经网络类"""
class experiment_1_Network(Network):
        ...
        for i in range(epochs):
            ...
            if test_data and i%100==0:
                ...
                print("Epoch {} : 逼近值：{:.8f} / {:.8f}  测试值：{:.8f}/{:.8f} 准确率：{}/{}".format(i,
                       renormalize(self.feedforward(0.009))[0][0], Target_Function(0.9),
                       renormalize(self.feedforward(rand_num))[0][0],Target_Function(rand_num),
...
if __name__ =="__main__":
    ...
    net.train_by_SGD(training_data=training_data, epochs=50, mini_batch_size=20, learning_rate=1,
                     )
